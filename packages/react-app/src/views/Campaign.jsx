...
const Campaign = ({
  ...
  const {
    ...
    donorCount,
    lendingPercentage,
    generatedIncome: initialGeneratedIncome,
    incomeDistributions,
                  ...
                  <Col span={7}>
                    <nav className="campaign-menu">
                      ...
                      <ScrollLink
                        ...
                        duration={500}
                      >
                        <span className="gray-line"></span>Assets
                      </ScrollLink>
                      <ScrollLink
                        ...
                        duration={500}
                      >
                        <span className="gray-line"></span>Income Distributions
                      </ScrollLink>
                      <ScrollLink
                        to="governance"
                        className="nav-item sub disabled"
                        activeClass="is-active"
                        spy={true}
                        smooth={true}
                        offset={50}
                        duration={500}
                      >
                        <span className="gray-line"></span>Governance{" "}
                      ...
                      <ScrollLink
                        ...
                        duration={500}
                      >
                        <span className="gray-line"></span>Wallet Addresses
                      </ScrollLink>
                    </nav>
                  </Col>
                  <Col span={17}>
                    ...
                    {/* 
                                            Images 
                                        */}
                    <section className="campaign-image-container" alt={organisationName}>
                      <Carousel dotPosition="right" autoplay autoplaySpeed="40" effect="fade">
                        {images &&
                          images.map(img => (
                            <div>
                              <div className="campaign-image" style={{ backgroundImage: `url(${img})` }}></div>
                            </div>
                          ))}
                      </Carousel>
                    </section>
                    ...
                    <section className="finances">
                      <Element name="finances" className="element">
                        ...
                        <section className="income-generating-assets">
                          ...
                          <Row gutter={8}>
                            <Col span={16}>{chartConfig && <DualAxes {...chartConfig} />}</Col>
                            <Col span={1}></Col>
                            <Col span={7}>
                              <Statistic
                                title="Income-generating Donations"
                                value={raised ? raised * 0.5 : 0}
                                prefix="$"
                              />
                              <Divider />
                              <Statistic
                                title="Generated Income"
                                value={generatedIncome ? generatedIncome.toFixed(2) : 0}
                                prefix="$"
                                precision="2"
                        ...
                        <section className="income-distributions">
                          ...
                          {incomeDistributions &&
                            incomeDistributions.map((distribution, i) => (
        ...
        <Col span={6}>
          <div className="campaign-sidebar">
            ...
            <div className="progress">
              ...
              <AnimatedNumber value={generatedIncome} formatValue={formatValue} duration={1000} />
            </div>
            ...
            <section className="timeline">
              <Steps current={1} size="small" direction="vertical" progressDot>
                ...
                <Step
                  title="In Progress"
                  subTitle={`Left 3 days`}
                  description={
                    <>
                      Accepting donations.
                      <br />
                      Generating income using donations
                    </>
                  }
                  status="process"
                />
                <Step
                  title={endDate && moment(endDate).format("DD MMM YYYY")}
                  description="All funds will be withdrawn from vaults and sent to project wallet."
                />
              </Steps>
            </section>
          </div>
...
const dummyCampaignInfo = {
  ...
  description:
    "The wildlife trade is a multi-billion dollar industry that threatens endangered species' survival and human health as zoonotic diseases such as COVID-19 emerge. Cambodia is both a wildlife source and transit country, and illegal trafficking was rampant in 2001 when the Wildlife Rapid Rescue Team (WRRT) was established to crack down on the trade. To date, WRRT has rescued over 69,000 live animals, apprehended over 7,700 traders, and confiscated large quantities of animal parts and contraband.",
  images: [
    "https://i.imgur.com/XxWLj09.jpg",
    "https://i.imgur.com/8E6xldh.jpg",
    "https://i.imgur.com/zbneBGE.jpg",
    "https://i.imgur.com/c25Ul4t.jpg",
  ],
